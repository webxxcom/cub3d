...
CC			= cc
CFLAGS		= -Wall -Wextra -Werror -g -O1 -Wnull-dereference -Wuninitialized #-Wunused -pedantic -Wconversion
...
SRCS		= main.c \
			  $(SRC_FLDR)/game/exit.c $(SRC_FLDR)/game/hooks.c $(SRC_FLDR)/game/key_press_hook.c \
				...
				$(SRC_FLDR)/game/inits.c $(SRC_FLDR)/game/inits2.c $(SRC_FLDR)/game/frame.c \
				$(SRC_FLDR)/game/animation.c $(SRC_FLDR)/game/animation_move.c \
			  ...
			  $(SRC_FLDR)/render/render.c $(SRC_FLDR)/render/put_minimap.c $(SRC_FLDR)/render/perform_dda.c \
			  	$(SRC_FLDR)/render/draw_vert_line.c $(SRC_FLDR)/render/draw_utils.c \
				$(SRC_FLDR)/render/sprite.c $(SRC_FLDR)/render/draw_floor_and_ceiling.c \
