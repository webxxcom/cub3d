...
/*   Updated: 2026/02/12 09:32:02 by danslav1e        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void								add_crossed_texture(t_game *g, t_dda_d *dda,
										t_obs_data *wall_data,
										t_dda_ray *dda_res);
t_dda_d								get_dda_start_data(t_game *const g,
										int const screen_x);
void								move_by_x(t_dda_d *const dda,
										t_obs_data *const walld);
void								move_by_y(t_dda_d *const dda,
										t_obs_data *const walld);
void								add_crossed_texture(t_game *g, t_dda_d *dda,
										t_obs_data *wall_data,
										t_dda_ray *dda_res);
...
void								put_ui_text(t_game *g, char *text,
										uint32_t color);
